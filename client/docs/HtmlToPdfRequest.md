# Cloudmersive.APIClient.NETCore.DocumentAndDataConvert.Model.HtmlToPdfRequest
## Properties
...
**AutoSanitize** | **bool?** | Optional: Automatically sanitize unsafe elements from the input HTML.  If disabled, and unsafe elements remain in the input HTML, the request will be blocked.  Default is true. | [optional] 
