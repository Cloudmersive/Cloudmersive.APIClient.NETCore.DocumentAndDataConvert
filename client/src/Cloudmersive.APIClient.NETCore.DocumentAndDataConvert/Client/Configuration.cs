...
namespace Cloudmersive.APIClient.NETCore.DocumentAndDataConvert.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/2.2.9/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/2.2.9/csharp"
        ...
        {
            String report = "C# SDK (Cloudmersive.APIClient.NETCore.DocumentAndDataConvert) Debug Report:\n";
            report += "    OS: " + System.Runtime.InteropServices.RuntimeInformation.OSDescription + "\n";
            report += "    Version of the API: v1\n";
            report += "    SDK Package Version: 2.2.9\n";
